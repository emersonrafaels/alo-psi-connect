...
DROP POLICY IF EXISTS "Anyone can view default emotion types" ON public.default_emotion_types;
DROP POLICY IF EXISTS "Users can view their own emotion configurations" ON public.emotion_configurations;
DROP POLICY IF EXISTS "Users can insert their own emotion configurations" ON public.emotion_configurations;
DROP POLICY IF EXISTS "Users can update their own emotion configurations" ON public.emotion_configurations;
DROP POLICY IF EXISTS "Users can delete their own emotion configurations" ON public.emotion_configurations;
DROP POLICY IF EXISTS "Admins can view all emotion configurations" ON public.emotion_configurations;
DROP POLICY IF EXISTS "Admins can manage default emotion types" ON public.default_emotion_types;
...
DROP TRIGGER IF EXISTS update_emotion_configurations_updated_at ON public.emotion_configurations;
