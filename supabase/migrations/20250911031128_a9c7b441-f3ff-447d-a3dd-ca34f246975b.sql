-- Insert default AI Assistant configurations with proper JSON values
...
-- Create default N8N chat configurations with proper JSON values
INSERT INTO system_configurations (category, key, value, description)
VALUES 
  ('n8n_chat', 'payload_template', '"{\"event\": \"ai_chat_message\", \"timestamp\": \"{{timestamp}}\", \"session_id\": \"{{session_id}}\", \"user\": {\"message\": \"{{user_message}}\", \"context\": \"{{context}}\", \"page\": \"{{page}}\", \"filters\": {{filters}}}, \"professionals\": {{professionals}}, \"platform\": \"alopsi\"}"', 'Template do payload para webhook N8N do chat'),
