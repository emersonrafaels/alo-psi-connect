...
-- Create enriched version with additional data
...
RETURNS TABLE(
  ...
  time_slot integer,
  -- Demographic data from profiles
  genero text,
...
BEGIN
  ...
  -- Aggregate institutions for each professional
  ...
  -- Get tenant info for each professional
  ...
  GROUP BY 
    ...
    pia.institutions, pti.tenant_info
