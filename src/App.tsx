...
const AppWithShortcuts = () => {
  ...
  return (
    <Routes>
      ...
      <Route path="/admin/blog-analytics" element={<AdminLayout><BlogAnalytics /></AdminLayout>} />
      <Route path="/admin/post-analytics/:postId" element={<AdminLayout><PostAnalytics /></AdminLayout>} />
