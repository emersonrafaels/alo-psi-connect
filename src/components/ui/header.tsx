...
const Header = () => {
  ...
  const allNavigation = [
    ...
    { name: "Apoios", href: buildTenantPath(tenantSlug, '/biblioteca-apoios'), module: null },
    ...
    ...(user && modulesEnabled?.buddy === true
      ? [{ name: "Meu Buddy", href: buildTenantPath(tenantSlug, '/buddy'), module: null }]
      : []),
