...
const moodOptions = [
  { label: "Muito ruim", emoji: "☹️", color: "text-rose-500", bg: "bg-rose-100" },
  { label: "Ruim", emoji: "🙁", color: "text-orange-500", bg: "bg-orange-100" },
  { label: "Neutro", emoji: "😐", color: "text-amber-500", bg: "bg-amber-100" },
  { label: "Bem", emoji: "🙂", color: "text-emerald-500", bg: "bg-emerald-100" },
  { label: "Muito bem", emoji: "😄", color: "text-teal-500", bg: "bg-teal-100" },
];
...
const history = [
  { date: "12 Ago", day: "Ter", mood: "Muito bem", tags: ["Gratidão", "Tranquilidade"], note: "Hoje foi um dia produtivo e me senti bem com minhas conquistas.", tone: "border-emerald-400" },
  { date: "10 Ago", day: "Dom", mood: "Bem", tags: ["Alegria", "Esperança"], note: "Consegui resolver algumas pendências e isso me deixou aliviado.", tone: "border-emerald-300" },
  { date: "08 Ago", day: "Sex", mood: "Neutro", tags: ["Cansaço", "Ansiedade"], note: "Dia puxado, mas consegui me organizar no final.", tone: "border-amber-300" },
  { date: "05 Ago", day: "Ter", mood: "Ruim", tags: ["Tristeza", "Estresse"], note: "Tive algumas dificuldades no trabalho e me senti sobrecarregado.", tone: "border-rose-300" },
];
...
const HiddenMoodDiaryPrototype = () => {
  return (
    <div className="min-h-screen bg-[#f5f7ff] p-3 md:p-6">
      <div className="mx-auto max-w-[1500px] space-y-6">
        <div className="grid gap-5 xl:grid-cols-[2.3fr_1.15fr]">
          <section className="overflow-hidden rounded-3xl border bg-white shadow-sm">
            ...
            <div className="grid md:grid-cols-[190px_1fr]">
              <aside className="border-r bg-[#fbfcff] p-4">
                <div className="space-y-2 text-sm text-[#2d4570]">
              ...
              <div className="space-y-5 p-5">
                <div className="flex flex-wrap items-start justify-between gap-3">
                  <div>
                    ...
                    <p className="mt-2 max-w-2xl text-sm text-[#426198]">
                    ...
                    <div className="grid grid-cols-2 gap-3 md:grid-cols-5">
                      {moodOptions.map((mood) => (
                        <div key={mood.label} className="text-center">
                          <div className={`mx-auto grid h-14 w-14 place-items-center rounded-full text-2xl ${mood.bg} ${mood.color}`}>{mood.emoji}</div>
                  ...
                  <div className="grid place-items-center rounded-2xl bg-gradient-to-br from-[#f4f7ff] to-[#eef0ff] p-6 text-center text-[#315186]">
                    <div>
                      ...
                      <p className="mt-2 italic">
                        “Cuidar da sua saúde emocional também é uma forma de se cuidar.”
                      </p>
                    </div>
                  </div>
                </div>
          ...
          <section className="overflow-hidden rounded-3xl border bg-white shadow-sm">
            ...
            <div className="space-y-4 p-4">
              ...
              <div className="flex items-center gap-3">
                <div className="rounded-lg bg-[#f1edff] p-2 text-[#5d35c3]">
                  <CalendarDays className="h-5 w-5" />
                </div>
                <div>
                  <h2 className="text-2xl font-bold text-[#112c6b]">Novo registro</h2>
                  <p className="text-sm text-[#426198]">Conte como você está se sentindo hoje.</p>
                </div>
              </div>
              <div className="space-y-3 rounded-xl border p-4">
                ...
                <div className="grid grid-cols-5 gap-2 text-center text-xs">
                  {moodOptions.map((mood) => (
                    <div key={mood.label}>
                      <div className={`mx-auto grid h-11 w-11 place-items-center rounded-full text-lg ${mood.bg} ${mood.color}`}>{mood.emoji}</div>
        ...
        <div className="grid gap-5 xl:grid-cols-[2fr_0.72fr_0.8fr]">
          <section className="overflow-hidden rounded-3xl border bg-white shadow-sm">
            <div className="flex items-center justify-between bg-[#4b2ca0] px-5 py-4 text-white">
              <div className="flex items-center gap-2 text-lg font-semibold">
                <Sparkles className="h-5 w-5 text-cyan-200" />
              ...
              <div className="text-sm">Diário Emocional</div>
            </div>
            <div className="grid md:grid-cols-[190px_1fr]">
              <aside className="border-r bg-[#fbfcff] p-4">
                <div className="space-y-2 text-sm text-[#2d4570]">
          ...
          <section className="overflow-hidden rounded-[34px] border bg-white shadow-sm">
            ...
            <div className="space-y-3 p-4 text-xs">
              ...
              <div className="rounded-lg border p-3">
                ...
                <div className="grid grid-cols-5 gap-1 text-center">
                  {moodOptions.map((mood) => (
                    <div key={mood.label}>
                      <div className={`mx-auto grid h-8 w-8 place-items-center rounded-full text-xs ${mood.bg}`}>{mood.emoji}</div>
              ...
              <div className="rounded-lg border p-3">
                <div className="mb-2 flex items-center justify-between text-sm font-semibold text-[#112c6b]">
                  ...
                  <span className="text-[#5d35c3]">Ver todos</span>
                </div>
          ...
          <section className="rounded-3xl border bg-gradient-to-br from-[#f4f6ff] to-[#f0f2ff] p-6">
            <h4 className="mb-4 flex items-center gap-2 text-4xl font-bold text-[#39229b]">
